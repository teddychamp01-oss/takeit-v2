...
const am = {
  ...
  saveForNextTime: '{name}ን ለሚቀጥለው ጊዜ ያስቀምጡ',
  workerSaved: '{name} ተቀምጧል። በሚቀጥለው ጊዜ በቀላሉ ያገኟቸዋል።',
  saveWorkerFailed: 'ማስቀመጥ አልተሳካም። እባክዎ እንደገና ይሞክሩ።',
...
const en: Record<keyof typeof am, string> = {
  ...
  saveForNextTime: 'Save {name} for next time',
  workerSaved: '{name} saved. Easy to find them next time.',
  saveWorkerFailed: 'Could not save. Please try again.',
