...
const am = {
  ...
  bookAgain: 'እንደገና ያስይዙ',
  checkArrival: 'የሚመጣው ሰው ይህ መሆኑን ያረጋግጡ።',
  safetyTitle: 'ደህንነት',
  safetyShieldAria: 'የደህንነት አማራጮች',
  safetyReportProblem: 'ችግር ሪፖርት ያድርጉ',
  ...
  paymentTitle: 'ክፍያ',
  paymentNonCustodial:
    'ሥራው ሲጠናቀቅ ክፍያ በቀጥታ በመካከላችሁ ይፈጸማል — በጥሬ ገንዘብ ወይም በባንክ ዝውውር። በTake It ላይ ክፍያ የሚፈጸመው በዚህ መንገድ ነው። Take It ገንዘብ በፍጹም አይይዝም፤ ክፍያውን እዚህ መዝግባችሁ ሁለታችሁም ያረጋግጡ።',
  paymentAmountLabel: 'የተከፈለው መጠን (ብር)',
  paymentAmountHint: 'ባዶ ከተተወ የተስማሙበት ዋጋ ይመዘገባል።',
  paymentLog: 'ክፍያውን መዝግብ',
...
const en: Record<keyof typeof am, string> = {
  ...
  checkArrival: 'Check this is who arrives.',
  safetyTitle: 'Safety',
  safetyShieldAria: 'Safety options',
  safetyReportProblem: 'Report a problem',
  ...
  paymentNonCustodial:
    'When the job is done, payment happens directly between you — cash or bank transfer. That is how paying works on Take It. Take It never holds the money; record the payment here so both of you have confirmed it.',
  paymentAmountLabel: 'Amount paid (birr)',
  paymentAmountHint: 'Leave empty to log the agreed price.',
  paymentLog: 'Record payment',
